...
class StudentSocketImpl extends BaseSocketImpl {
    ...
    /**
     * create TCPTimer instance, handling tcpTimer creation
     * @param delay time in milliseconds before call
     * @param ref generic reference to be returned to handleTimer
     */
    private TCPTimer createTimerTask(long delay, Object ref){
        if(tcpTimer == null)
            tcpTimer = new Timer(false);
        return new TCPTimer(tcpTimer, delay, this, ref);
    }


    /**
     * handle timer expiration (called by TCPTimer)
